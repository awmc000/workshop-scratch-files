 ...
 * Author: ZyBooks
 * 
 * Desc: static printing methods for 
 * both BST and AVL nodes. 
 */
public class AVLPrint {
   /* Method: treeToString()
    * 
    * Input: Node<T> - root of tree to print
    *
    * Output: Fully formatted diagram in string form
    * 
    * Desc: A near-duplicate method for BSTNode type follows
    */
    ...
    * Input: Node<T> - root of tree to print
    *
    * Output: String[] - contains lines of diagram
    * 
    * Desc: A near-duplicate method for BSTNode type follows
    */
   ...
   /* Method: treeToString()
    * 
    * Input: BSTNode<T> - root of tree to print
    *
    * Output: String - fully formatted diagram of tree
    * 
    * Desc: A near-duplicate method of the one for Node<T>
    */
   ...
   /* Method: treeToLines()
    * 
    * Input: BSTNode<T> - root of string to print
    *
    * Output: String - fully formatted diagram of tree
    * 
    * Desc: A near-duplicate method of the one for Node<T>
   ...
   /* Method: getRepeated()
    *
    * Input: char, int - what character to repeat, how many times
    * 
    * Output: String of desired character desired # of times.
    */
    ...
    * 
    * Output: String: string containing num of spaces desired
    *
    * Ex.: getSpaces(3) = "   " or, to visualize, "..." where each . 
    * represents a space
    */
   ...
   /* Method: indentLines
    *
    * Input: String[], int - Array of lines, number of spaces to indent
    * with
    *
    * Output: None, manipulates string arr in place.
    */
